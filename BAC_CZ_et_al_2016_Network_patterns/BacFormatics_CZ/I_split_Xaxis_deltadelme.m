...
matrix_in2 =zeros(size(matrix_in,1)+4,size(matrix_in,2)+4); matrix_in2(2:end-3,2:end-3)=matrix_in; matrix_in=matrix_in2;    
matrix_raw2 =zeros(size(matrix_raw,1)+4,size(matrix_raw,2)+4); matrix_raw2(2:end-3,2:end-3)=matrix_raw; matrix_raw=matrix_raw2;  
% Close
% figure
%   load  matrix_in
%  load matrix_raw
...
matrix2=matrix_in2 ;
matrix1= double(matrix_raw).*double(matrix2);   
...
matrix11 = imrotate(matrix1, -Orientation);
matrix22 = imrotate(matrix2, -Orientation);


matrix22=bwlabel_max(matrix22);
 matrix11=matrix11./matrix11;
...
matrix0 = imrotate(matrix0,  Orientation);
